get_filename_component(EGRESSLIB_CMAKE_DIR "${CMAKE_CURRENT_LIST_FILE}" PATH)
...
if(NOT TARGET HDTN::EgressLib)
    include("${EGRESSLIB_CMAKE_DIR}/EgressLibTargets.cmake")
endif()

set(EGRESSLIB_LIBRARIES HDTN::EgressLib)
